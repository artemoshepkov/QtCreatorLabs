...
InputDialog_Oshepkov_Artem::InputDialog_Oshepkov_Artem(QWidget* pwgt) : QDialog(pwgt)
{
...
QString InputDialog_Oshepkov_Artem::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Oshepkov_Artem::lastName() const
{
